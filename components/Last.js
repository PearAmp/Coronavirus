    ...
    <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.Imagewrap}>
            <Image
              style={styles.images}
              source={require('../assest/images/doctor.png')}
            />
          </View>
        ...
        <View style={styles.Items}>
            ...
            <View style={{borderColor: '#CFD8DC', borderWidth: 5, width: 10, borderRadius: 50, marginRight: 10}} />
            <View style={{width: 40, borderRadius: 40, backgroundColor: '#37474F'}} />

        </View>

        {/* Button */}
        <TouchableOpacity style={styles.buttonwrap} onPress={() => navigation.navigate('Contentcovid')}>
